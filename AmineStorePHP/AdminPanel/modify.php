...
$sqlee = "SELECT productos.nombre as nombre ,  productos.descripcion as descripcion, productos.precio as precio , productos.existencias as existencias , productos.urlimagen as urlimagen,"
        . "productos.id as id,categorias.nombre as nombree  FROM productos , categorias where categorias.id=productos.idcategoria and productos.id=".$_GET["id"]."";
...
if(isset($_GET["save"])){
    ...
    $sqlee = "UPDATE productos SET  descripcion ='$description' , precio =$price , existencias= $stock, urlimagen = '$imageurl'  WHERE id = $id" ;
    if(mysqli_query($db,$sqlee)){
        header('Location: messagepage.php?id=2');
    }  
    else {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Modify Product '<?php echo $name;?>'</div>
                         ...
                         <div class="card-body">
                            ...
                            <form action="" method="get">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="imageurl" value="<?php echo $imageurl;?>" >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  <label>Brand</label>
                                  <input type="text" class="form-control" name="brand" value="<?php echo $brand;?>" disabled="">
                                </div>
