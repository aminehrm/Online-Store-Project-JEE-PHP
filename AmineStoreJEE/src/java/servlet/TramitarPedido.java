...
public class TramitarPedido extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        session.removeAttribute(constantes.SESSION_PEDIDO);
        session.removeAttribute(constantes.SESSION_CARRITO);
        
       
        request.setAttribute("VALIDACION", validacion);
        request.getRequestDispatcher("/web/order/fin_pedido.jsp").forward(request, response);
